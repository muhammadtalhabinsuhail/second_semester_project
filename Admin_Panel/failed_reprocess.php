...
$query = "SELECT * FROM failed_copy_table14 WHERE Product_Test_Id='{$Product_Test_Id}';";
...
if ( mysqli_num_rows( $data ) > 0 ){
    ...
    $query3 = "DELETE FROM failed_copy_table14 WHERE Product_Test_Id='{$Product_Test_Id}';";
