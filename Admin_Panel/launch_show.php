...
$query = "SELECT * FROM ApprovedProducts_Launch_table23 ORDER BY Product_Status DESC;";
$data = mysqli_query( $conn, $query ) or die ( 'query Failed' );
if ( mysqli_num_rows( $data ) > 0 ) {
    ?>
                                                            <h4 class="card-title">Launching Products</h4>
                                                                   ...
                                                                   ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <p type="text" name="Product_Test_Id"
                                                                        ...
                                                                        if($rows[ 'Product_Status' ]==="Ready To Launch"){

                                                                        ?>
                                                                        <td>
                                                                            <form method="post" action="openform.php">
                                                                                <input type="hidden"
                                                                     ...
                                                                     ?>
                                                                        <td>
                                                                            <label class="badge badge-success">You
                                                                                have successfully
                                                                                launched
                                                                            </label>
                                                                        </td>
