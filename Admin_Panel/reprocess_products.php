...
$query = "SELECT * FROM reprocess_failedproducts_table11 ;";
$data = mysqli_query( $conn, $query ) or die ( 'query Failed' );
if ( mysqli_num_rows( $data ) > 0 ) {
    ?>
                                                            <h4 class="card-title">Reprocessing Products</h4>
                                                            ...
                                                            <table class="table">
                                                                ...
                                                                <thead style="border-bottom: 2px solid black;">
                                                                    <tr>
                                                                        ...
                                                                        <th><b>Receive Failed Reprocess</b></th>
                                                                        <th><b>Product Status</b></th>
                                                                        <th><b>Description</b></th>
                                                                        <th><b>Ready For CPRI</b></th>
                                                                   ...
                                                                   while( $rows = mysqli_fetch_assoc( $data ) ) 
                                                                 {
                                                                   ...
                                                                   ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <form action="testtype_description.php"
                                                                                method="post">
                                                                                <input type="hidden"
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <?php echo $rows[ 'Receive_Failed_Reprocess' ];?>
