...
$query = "SELECT * FROM CPRI_approvefortestcopy_table20 ;";
$data = mysqli_query( $conn, $query ) or die ( 'query Failed' );
if ( mysqli_num_rows( $data ) > 0 ) {
    ?>
                                                            <h4 class="card-title">Approved Products By CPRI</h4>
                                                            ...
                                                            <table class="table">
                                                                ...
                                                                <thead style="border-bottom: 2px solid black;">
                                                                    <tr>
                                                                        ...
                                                                        <th><b>Product Approved</b></th>
                                                                        <th><b>Product Status</b></th>
                                                                        <th><b>CPRI Test</b></th>
                                                                        <th><b>Receive For Launch</b></th>
                                                                   ...
                                                                   while( $rows = mysqli_fetch_assoc( $data ) ) 
                                                                 {
                                                                   ...
                                                                   ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <form method="post"
                                                                                action="launch_process.php">
                                                                                <input type="hidden" name="take_it"
