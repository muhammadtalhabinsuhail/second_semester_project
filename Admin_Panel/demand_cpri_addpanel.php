...
$query = "SELECT * FROM CPRI_demandfortest_table24 ;";
                                                            ...
                                                            <table class="table">
                                                                ...
                                                                <thead style="border-bottom: 2px solid black;">
                                                                    <tr>
                                                                        ...
                                                                        <th><b>Demand Test</b></th>
                                                                        <th><b>Dismiss As Read</b></th>
                                                                   ...
                                                                   ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <form action="demanddismiss_byaddpanel.php"
                                                                                method="post">
                                                                                <input type="hidden"
