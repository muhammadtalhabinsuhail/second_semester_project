...
$query = "SELECT * FROM product_acceptedcopy_table8 ";
$data = mysqli_query( $conn, $query ) or die ( 'query Failed' );
if ( mysqli_num_rows( $data ) > 0 ) {
    ?>
                                                            <h4 class="card-title">Accepted Products</h4>
                                                                   ...
                                                                   ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <?php echo $rows[ 'Accepted_Test_Date' ];?>
...
?>
                                                                        ...
                                                                        <td>
                                                                            <form action="decline_product2.php"
                                                                                method="post">
                                                                                <input type="hidden"
                                                                                    name="Product_Test_Id"
                                                                                    value="<?php echo $rows['Product_Test_Id']; ?>">
                                                                                <button class="btn btn-danger"
                                                                                    ...
                                                                                    style="padding:5px;">Decline For
                                                                                    Test
                                                                                </button>
                                                                            </form>
                                                                            <br>
                                                                            <form action="undertest_process.php"
                                                                                method="post">
                                                                                <input type="hidden"
                                                                                    name="Product_Test_Id"
                                                                                    value="<?php echo $rows['Product_Test_Id']; ?>">
                                                                                <button class="btn btn-warning"
                                                                                    name="Accept" style="padding:5px;"
                                                                                    type="submit">Accept
                                                                                    For Test</button>
                                                                            </form>
                                                                        </td>
