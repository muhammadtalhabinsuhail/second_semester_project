<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="navbar-brand-wrapper d-flex align-items-center">
        <a class="navbar-brand brand-logo" href="index.php">
            <img src="images\SRS PROJECT LOGO.png" alt="logo" class="logo-dark"
                style="height:125px; width: 600px; position:relative; left:27px; top: 5px;" />
        </a>
        <hr style="color:azure">
        <a class="navbar-brand brand-logo-mini" href="index.php"><img src="images\SRS PROJECT LOGO.png"
                alt="logo" /></a>
    </div>
    <div class="navbar-menu-wrapper d-flex align-items-center flex-grow-1">
        <h5 class="mb-0 font-weight-medium d-none d-lg-flex">Welcome to SRS Admin dashboard!</h5>
            ...
            <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
                <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown"
                    ...
                    <img class="img-xs rounded-circle ml-2" src="images/faces/face8.jpg" alt="Profile image"> <span
                        class="font-weight-normal"> SRS Admin </span></a>
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                    <div class="dropdown-header text-center">
                        <img class="img-md rounded-circle" src="images/faces/face8.jpg" alt="Profile image">
                        <p class="mb-1 mt-3">SRS Admin</p>
                        <p class="font-weight-light text-muted mb-0">srs.admin@gmail.com</p>
                    </div>
