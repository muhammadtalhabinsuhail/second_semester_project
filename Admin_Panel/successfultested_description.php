...
<body>
    ...
    $query = "SELECT * FROM successfully_tested_table4 WHERE Product_Id = '{$Product_Id}'";
        ...
        while( $rows = mysqli_fetch_assoc( $data ) ) 
 {
            ...
            ?>
                                                                    ...
                                                                    <td>
                                                                        <?php echo $rows[ 'Product_Registration' ];
            ?>
                                                                    </td>

                                                                    <td>
                                                                        <?php echo $rows[ 'Product_Sending_Test_Date' ];
            ?>
                                                                    </td>

                                                                    <td>
                                                                        <?php echo $rows[ 'Product_Report_Sending_Test_Date' ];
            ?>
                                                                    </td>
