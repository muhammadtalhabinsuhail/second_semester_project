...
<body>
    ...
    $query = "SELECT * FROM products_undertesting_table9 WHERE Product_Id = '{$Product_Id}'";
    ...
    if ( mysqli_num_rows( $data ) >0 ) {
        while( $rows = mysqli_fetch_assoc( $data ) ) {
            ...
            ?>
                                                ...
                                                <form class='forms-sample' method='Post' action='reportjudgement.php'
            ...
            ?></textarea>
                                                    ...
                                                    <button class='btn btn-success mr-2' type='submit'
                                                        name="successful">Successfully
                                                        Tested</button>
                                                    <button class='btn btn-danger' name="fail"
