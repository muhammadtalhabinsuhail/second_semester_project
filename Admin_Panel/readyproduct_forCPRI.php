...
<body>
    <div class='container-scroller'>
                                ...
                                <div class='card-body'>
                                    <div class='col-12 grid-margin stretch-card'>
                                        <div class='card'>
                                            <div class='card-body'>
                                                <center>
                                                    <h2 class='card-title'><b>Ready For CPRI Test </b></h2>
                                                </center>
                                                <hr>
        ...
        $query = "SELECT * FROM success_copy_table15 WHERE Product_Test_Id = '{$Product_Test_Id}';";
            ...
            while( $rows = mysqli_fetch_assoc( $data ) ) {
                ...
                ?>
                                                ...
                                                <form class='forms-sample' method='Post'
                                                    action='sending_CPRI_process.php' onsubmit='return validateForm()'>
                                                    ...
                                                    <div class='form-group'>
                                                        <label for='exampleInputName1'>Product Sending To CPRI
                                                            Date:</label>
                                                        <script>
                                                    ...
                                                    <div class='form-group'>
                                                        <label for='exampleInputName1'>Update Product
                                                            Description As Report:</label>
                ...
                ?></textarea>
                                                    ...
                                                    <button class='btn btn-dark mr-2' type='submit' name="sendcpri">Send
                                                        Now</button>
