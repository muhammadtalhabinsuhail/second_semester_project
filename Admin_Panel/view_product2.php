...
$query = "SELECT *
FROM manufactured_products_table2;";
...
if ( mysqli_num_rows( $data ) > 0 ) {
                                                            ...
                                                            <table class="table">
                                                                ...
                                                                <thead style="border-bottom: 2px solid black;">
                                                                    <tr>
                                                                        ...
                                                                        <th><b>Product Manufactured</b></th>
 ...
 ?>
                                                                        ...
                                                                        <td>
                                                                            <form method="post"
                                                                                action="description_for_manufactured.php">
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <form action="update2_product.php"
                                                                                method="post">
                                                                                <input type="hidden" name="Product_Id"
                                                                                    value="<?php echo $rows['Product_Id']; ?>">
                                                                            ...
                                                                            <form action="delete_product2.php"
                                                                                method="post">
                                                                                <input type="hidden" name="Product_Id"
                                                                                    value="<?php echo $rows['Product_Id']; ?>">
