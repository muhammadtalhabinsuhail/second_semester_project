...
if ( isset( $_POST[ 'undertesting_condition' ] ) ) {
...
<body>
                                ...
                                <div class='card-body'>
                                    <div class='col-12 grid-margin stretch-card'>
                                        <div class='card'>
                                            <div class='card-body'>
                                                <center>
                                                    <h2 class='card-title'><b>Approve Or Fail Product Now...</b></h2>
                                                </center>
                                                <hr>
    ...
    $query = "SELECT * FROM CPRI_acceptfortest_table18 WHERE Product_Id = '{$Product_Id}'";
    ...
    if ( mysqli_num_rows( $data ) >0 ) {
        while( $rows = mysqli_fetch_assoc( $data ) ) {
            ...
            ?>
                                                ...
                                                <form class='forms-sample' method='Post' action='cpri_judgement.php'
                                                    ...
                                                    <div class='form-group'>
                                                        <label for='exampleInputName1'>Name Of CPRI Test:</label>
                                                    ...
                                                    <button class='btn btn-success mr-2' type='submit'
                                                        name="approve">Approve Product</button>
                                                    <button class='btn btn-danger' name="fails"
                                                        type="submit">Failure</button>
                                                </form>
                                                <script>
