...
$query = "SELECT * FROM success_copy_table15 ;";
$data = mysqli_query( $conn, $query ) or die ( 'query Failed' );
if ( mysqli_num_rows( $data ) > 0 ) {
    ?>
                                                            <h4 class="card-title">Successfully Tested Products</h4>
                                                                   ...
                                                                   while( $rows = mysqli_fetch_assoc( $data ) ) 
                                                                 {
                                                                   ...
                                                                   ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <form method="post" I
                                                                                action="readyproduct_forCPRI.php">
                                                                                <input type="hidden"
                                                                                    name="Product_Test_Id"
                                                                                    value="<?php echo $rows['Product_Test_Id']; ?>">
                                                                                <button class="btn btn-warning"
                                                                                    ...
                                                                                    style="padding:10px;">
                                                                                    Go Ahead <i
                                                                                        class="icon-doc menu-icon  icon-paper-plane"></i>
                                                                                </button>
