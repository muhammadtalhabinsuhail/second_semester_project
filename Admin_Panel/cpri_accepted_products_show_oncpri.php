...
$query = "SELECT * FROM CPRI_acceptproducts_table17 ORDER BY Product_Name";
                                                                   ...
                                                                   while( $rows = mysqli_fetch_assoc( $data ) ) 
                                                                 {
                                                                   ...
                                                                   ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <form action="cpri_demandfor_othertest.php"
                                                                                method="post">
                                                                                <input type="hidden"
                                                                                    name="Product_Test_Id"
                                                                                    value="<?php echo $rows['Product_Test_Id']; ?>">
                                                                                <button class="btn btn-info"
                                                                                    name="needothertest" type="submit"
                                                                                    style="padding:5px;">Need Other
                                                                                    Test
                                                                                </button>
                                                                            </form>
                                                                            <br>
                                                                            <form action="cpri_undergo_fortest.php"
                                                                                method="post">
                                                                                <input type="hidden"
                                                                                    name="Product_Test_Id"
                                                                                    value="<?php echo $rows['Product_Test_Id']; ?>">
