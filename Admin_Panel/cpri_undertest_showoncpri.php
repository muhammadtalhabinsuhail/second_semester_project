...
$query = "SELECT * FROM CPRI_acceptfortest_table18 ;";
$data = mysqli_query( $conn, $query ) or die ( 'query Failed' );
if ( mysqli_num_rows( $data ) > 0 ) {
    ?>
                                                            <h4 class="card-title">CPRI Undertesting Products</h4>
                                                                   ...
                                                                   ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <form action="cpri_formreporting.php"
                                                                                method="post">
